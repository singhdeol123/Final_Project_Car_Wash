...
namespace Final_Project_Car_Wash.Areas.Identity.Pages.Account
{
    [Authorize(Roles = "carwashAdmin")]
    public class RegistercarwashAdminModel : PageModel
    {
        private readonly SignInManager<IdentityUser> _signInManager;
        private readonly UserManager<IdentityUser> _userManager;
        private readonly ILogger<RegistercarwashAdminModel> _logger;
        private readonly IEmailSender _emailSender;
        private RoleManager<IdentityRole> _roleManager;
       

        public RegistercarwashAdminModel(
            UserManager<IdentityUser> userManager,
            SignInManager<IdentityUser> signInManager,
            ILogger<RegistercarwashAdminModel> logger,
            IEmailSender emailSender,
            Final_Project_Car_WashContext dataContext
            )
        {
